...
HPO_SPACE=${HPO_SPACE:-scenario42_utd} # scenario23_utd | scenario23_mmfit
STUDY_NAME=${STUDY_NAME:-sc42_utd_p1[2]}  # descriptive study name
N_TRIALS=${N_TRIALS:-25}              # number of HPO trials
