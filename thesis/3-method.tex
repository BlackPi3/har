...
Without GRL, training typically requires alternating min–max updates between the discriminator and feature extractor, which is more sensitive to imbalance and can lead to unstable dynamics (e.g., discriminator domination) and weaker alignment.
