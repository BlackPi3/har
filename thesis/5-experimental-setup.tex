...
The University of Texas at Dallas Multimodal Human Action Dataset (UTD-MHAD) \cite{chen2015utd} is a benchmark dataset for multimodal action recognition. It captures human activities using both a Microsoft Kinect sensor and a wearable inertial sensor.
...
The MM-Fit dataset \cite{stromback2020mm} captures fitness activities in a gym setting, providing synchronized video and wearable sensor data from multiple body locations.
...
\subsubsection{Feature-level Discriminator (Scenario 4.1)}
...
\subsubsection{Signal-level Discriminator (Scenario 4.2)}
